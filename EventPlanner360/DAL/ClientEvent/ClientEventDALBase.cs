...
using System.Data;
using EventPlanner360.Areas.Event.Models;
using EventPlanner360.Areas.ClientEvent.Models;
using Newtonsoft.Json;
using EventPlanner360.BAL;
using EventPlanner360.DAL;

namespace EventPlanner360.DAL.ClientEvent
{
